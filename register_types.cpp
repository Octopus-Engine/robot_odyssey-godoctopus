...
void initialize_godoctopus2_module(ModuleInitializationLevel p_level) {
	...
	ClassDB::register_class<godot::UnitLoadoutResource>();
	ClassDB::register_class<godot::RuneInfoResource>();
	ClassDB::register_class<godot::UnitRuneSlotResource>();
	...
	ClassDB::register_class<godot::ParticleOrchestrated>();
