...
void declare_aoe_pulse_triggers(flecs::world &ecs, octopus::PositionContext const &ctx)
{
	...
	declare_periodic_area_trigger_system<AoePulseHealBasedOnDamage, AlwaysCondition, HealAreaEventPeriodicDamageBased<10, 3, 6>>(ecs, ctx);
	...
	declare_periodic_area_trigger_system<AoePulseDamageBasedOnDamage, AlwaysCondition, DamageAreaEventPeriodicDamageBased<10, 3, 6>>(ecs, ctx);
	...
	declare_periodic_area_trigger_system<AoePulseHealBasedOnDamageTier2, AlwaysCondition, HealAreaEventPeriodicDamageBased<20, 3, 10>>(ecs, ctx);
	...
	declare_periodic_area_trigger_system<AoePulseDamageBasedOnDamageTier2, AlwaysCondition, DamageAreaEventPeriodicDamageBased<20, 3, 10>>(ecs, ctx);
}
